// src/services/salesService.js - For Sales Executive Frontend
...
const salesService = {
  ...
  // Fetches all sales records (backend automatically filters by logged-in user's role)
  ...
  // Fetches aggregated sales summary report (backend filters by role)
